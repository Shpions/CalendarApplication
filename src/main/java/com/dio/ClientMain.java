...
//local code review (vtegza): add libraries to project @ 09.03.15
//local code review (vtegza): separate project to different modules/client and service, keep configuration separately @ 09.03.15
public class ClientMain {
    ...
    public static void main(String[] args) throws RemoteException {
        ...
        //local code review (vtegza): use Arrays.asList @ 09.03.15
    ...
    list2.add(p6);
        ...
        //local code review (vtegza): clean up code @ 09.03.15
        ...
        //local code review (vtegza): extract variables @ 09.03.15
